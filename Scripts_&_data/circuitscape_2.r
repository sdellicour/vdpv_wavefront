circuitscape_2 = function(envVariable, envVariableName, resistance=TRUE, avgResistance=TRUE, fourCells=FALSE, fromCoor, toCoor, OS="Unix", prefix="", ID="", nberOfCores_CS=1)	{
	...
	colnames(lines1) = c("1","2","3") # new line inserted on the 31/03/2025
	...
	if (OS == "Unix")
		{
			system(paste("julia",paste(folder,"CS_script.jl",sep="/"),sep=" "), ignore.stdout=F, ignore.stderr=F)
		}		
