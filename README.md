This repo gathers the R scripts related to the wavefront analyses performed in the study entitled "**Unravelling spatiotemporal heterogeneities of wild and vaccine-derived poliovirus spread: past and present**" (Candido *et al*., *in press*, *Nat. Mircobiol.*), which are all gathered within the file `R_script_VDPV.r`.
